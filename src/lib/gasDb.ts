...
export const GAS_URL: string = "https://script.google.com/macros/s/AKfycbxFPnJm9fQloA3vEbM909DJLelsfN6nWSmJ6cLgEYojFZq-pcwza93rQmca4np7H-NC/execc";
...
const formatDateForSheet = (ts: any) => {
  if (!ts) return '';
  const d = new Date(ts);
